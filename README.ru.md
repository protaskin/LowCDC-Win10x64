...
Пакетный файл createcat.bat предназначен для создания подписанного каталога для пакета драйвера LowCDC-Win10x64, т.е. для выполнения шагов с 4-го по 8-й включительно.
